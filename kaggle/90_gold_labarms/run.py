...
# NOT A SUBMISSION. Scores E104's two label arms on the 58 gold
...
def main():
    ...
    if v1_probs is not None:
        # FIFTY-FIFTY, AND NOTHING FITTED, for the fifth time (E048, E069, E081,
        # E084, `knee-blend-raptor`). E101 swept this pair on the 58 gold and the
        # peak sits at w=0.3 -- but 0.5 is on the same plateau and the +0.0022
        # between them is BELOW the board's own +/-0.003 reseed floor (E092), so a
        # fitted weight would buy a difference the board cannot measure.
        #
