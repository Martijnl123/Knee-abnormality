...
# NOT A SUBMISSION. The three CoAtNet checkpoints run one span
...
#
MEMBERS_EXPECTED = 3
ARMS             = ({'name': 'maxspan-v5-span04', 'file': 'raptor_ft_coatnet_v5_full_swa.pt', 'img': 336, 'slots': (('Sagittal', 1, 18), ('Sagittal', 0, 14), ('Coronal', 1, 12), ('Coronal', 0, 8), ('Axial', -1, 12)), 'span': (0.06, 0.94), 'k_eval': 62, 'reverse': False, 'w': 1.0, 'expect_gold': 0.9214}, {'name': 'native384dense-v10-span04', 'file': 'raptor_ft_coatnet_v10_full.pt', 'img': 384, 'slots': (('Sagittal', 1, 18), ('Sagittal', 0, 14), ('Coronal', 1, 12), ('Coronal', 0, 8), ('Axial', -1, 12)), 'span': (0.06, 0.94), 'k_eval': 62, 'reverse': False, 'w': 1.0, 'expect_gold': 0.9174}, {'name': 'native384-v8-span04', 'file': 'raptor_ft_coatnet_v8_full_swa.pt', 'img': 384, 'slots': (('Sagittal', 1, 12), ('Sagittal', 0, 10), ('Coronal', 1, 8), ('Coronal', 0, 6), ('Axial', -1, 8)), 'span': (0.1, 0.9), 'k_eval': 42, 'reverse': False, 'w': 1.0, 'expect_gold': 0.9067})
CROP_MM          = 140.0
